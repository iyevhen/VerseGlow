...
{
	internal class nsEUCKRProber : AbstractCSProber
	{
		//void      GetDistribution(PRUint32 aCharLen, const char* aStr);

		private readonly CodingStateMachine mCodingSM;

		//private EUCKRContextAnalysis mContextAnalyser;
		private readonly EUCKRDistributionAnalysis mDistributionAnalyser = new EUCKRDistributionAnalysis();
