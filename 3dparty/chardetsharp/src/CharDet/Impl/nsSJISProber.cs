...
{
	internal class nsSJISProber : AbstractCSProber
	{
		private readonly CodingStateMachine mCodingSM;
		private readonly SJISContextAnalysis mContextAnalyser = new SJISContextAnalysis();
		private readonly SJISDistributionAnalysis mDistributionAnalyser = new SJISDistributionAnalysis();
