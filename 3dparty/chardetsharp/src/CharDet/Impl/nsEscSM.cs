...
namespace Mozilla.CharDet.Impl
{
	...
	{
		private static readonly int[] HZ_cls = new[]
			{
		...
		private static readonly int[] HZ_st = new[]
			{
		...
		private static readonly int[] ISO2022CNCharLenTable = new[] {0, 0, 0, 0, 0, 0, 0, 0, 0};
		...
		private static readonly int[] ISO2022CN_cls = new[]
			{
		...
		private static readonly int[] ISO2022CN_st = new[]
			{
		...
		private static readonly int[] ISO2022JP_cls = new[]
			{
				PkgInt.PCK4BITS(2, 0, 0, 0, 0, 0, 0, 0), // 00 - 07 
		...
		private static readonly int[] ISO2022JP_st = new[]
			{
				PkgInt.PCK4BITS(eStart, 3, eError, eStart, eStart, eStart, eStart, eStart), //00-07 
		...
		private static readonly int[] ISO2022KRCharLenTable = new[] {0, 0, 0, 0, 0, 0};
		...
		private static readonly int[] ISO2022KR_cls = new[]
			{
				PkgInt.PCK4BITS(2, 0, 0, 0, 0, 0, 0, 0), // 00 - 07 
				PkgInt.PCK4BITS(0, 0, 0, 0, 0, 0, 0, 0), // 08 - 0f 
				PkgInt.PCK4BITS(0, 0, 0, 0, 0, 0, 0, 0), // 10 - 17 
		...
		private static readonly int[] ISO2022KR_st = new[]
			{
		...
		private static int[] HZCharLenTable = new[] {0, 0, 0, 0, 0, 0};
		private static int[] ISO2022JPCharLenTable = new[] {0, 0, 0, 0, 0, 0, 0, 0};
