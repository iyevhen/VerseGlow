...
namespace Mozilla.CharDet.Impl
{
	internal partial class SequenceModel
	{
		...
		protected SequenceModel(byte[] charToOrderMap, byte[] precedenceMatrix, float mTypicalPositiveRatio,
		                        bool keepEnglishLetter, string charsetName)
		{
			this.charToOrderMap = charToOrderMap;
			this.precedenceMatrix = precedenceMatrix;
			this.mTypicalPositiveRatio = mTypicalPositiveRatio;
