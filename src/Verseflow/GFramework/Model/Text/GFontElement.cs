...
namespace VerseFlow.GFramework.Model.Text
{
    public class GFontElement : GTextElement
    {
        ...
        public override string TagName
        {
            get
            {
                return GTextDocument.FontNodeName;
            }
        }
        public string Face
        {
            get
            {
                return (string)GetPropertyValue(FacePropertyKey);
            }
            set
            {
                if (Face == value)
        ...
        public float ScaleX
        {
            get
            {
                return (float)GetPropertyValue(ScaleXPropertyKey);
            }
            set
            {
                if (ScaleX == value)
        ...
        public float ScaleY
        {
            get
            {
                return (float)GetPropertyValue(ScaleYPropertyKey);
            }
            set
            {
                if (ScaleY == value)
