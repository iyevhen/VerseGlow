...
{
	public partial class DisplayLiveView : UserControl
	{
		public DisplayLiveView()
		{
			InitializeComponent();
		}
	}
				...
				if (matches.Length > 0)
				{
					...
					using (Graphics graphics = _listBox.CreateGraphics())
					{
						for (int i = 0; i < _listBox.Items.Count; i++)
						{
							...
							var itemWidth = (int) graphics.MeasureString(((String) _listBox.Items[i]) + "_", _listBox.Font).Width;
